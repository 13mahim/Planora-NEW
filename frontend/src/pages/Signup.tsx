...
import { Mail, Lock, User, ArrowRight, ShieldCheck, Calendar } from "lucide-react";
      ...
      >
        <div className="bg-white p-10 rounded-[2.5rem] shadow-2xl shadow-neutral-200 border border-neutral-100">
          <div className="text-center mb-10">
            ...
            <p className="text-neutral-500 mt-2">Join Planora and start managing your events.</p>
          </div>
