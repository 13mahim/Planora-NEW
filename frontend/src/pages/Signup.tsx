      ...
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="max-w-md w-full">
        <div className="bg-white dark:bg-neutral-900 p-10 rounded-[2.5rem] shadow-2xl shadow-neutral-200 dark:shadow-neutral-900 border border-neutral-100 dark:border-neutral-800">
          ...
          <div className="mt-8 pt-6 border-t border-neutral-100 dark:border-neutral-800">
            <p className="text-center text-xs text-neutral-400 mb-4 font-bold uppercase tracking-widest">Or sign up with</p>
            <div className="flex gap-3">
              <button
                type="button"
                onClick={() => toast.info("Google signup coming soon! Use email for now.")}
              ...
              <button
                type="button"
                onClick={() => toast.info("Facebook signup coming soon! Use email for now.")}
